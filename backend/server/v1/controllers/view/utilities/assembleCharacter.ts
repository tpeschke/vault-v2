...
import socialSQL from '../../../queries/confrontation/get'
import skillSQL from '../../../queries/skill/get'
import combatSQL from '../../../queries/combat/get'
...
import { ViewRequest } from "../viewCharacterController";
...
export async function assembleCharacter(request: ViewRequest, response: Response, characterId: number, characterInfoArray: any) {
    const {
